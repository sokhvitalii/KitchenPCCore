...
namespace Parser.Parser
{
    ...
    public class TestJson
    {
        ...
        var test = new TestJson("vetal", 31);
                    ...
                    using (var fileStream = new FileStream(new Uri("/home/vitaliisokh/project/work/kitchenpc/test2/KitchenPCCore/ParserJson/Resources/Edamam_recipes.json", UriKind.Absolute).AbsolutePath, FileMode.Open))
                    {    
    ...
    public class ParseJson
    {
        ...
        { 
            var tmp = File.ReadAllText("../ParserJson/Resources/Edamam_recipes.json"); 
